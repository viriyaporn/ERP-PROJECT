    ...
    { field: 'Status', headerName: 'สถานะ', filter: true, width: 140 },
    {
      ...
      cellRenderer: info => (
        <div className="flex space-x-1 justify-center align-center">
          <button type="button" onClick={() => navigate('/trackstatus/report-detail')} className="rounded text-center text-blue-400 hover:text-blue-500"><AiFillEye className='text-xl' /></button>
    ...
    <>
      <Layout >
        <div className="flex justify-between p-2">
          <h1 className="font-bold text-3xl mb-5">รายงาน</h1>
          <div>
            <button
              type="button"
      ...
      <Modal
        ...
        body={
          ...
          // />
          <h1>ฟังก์ชันนี้กำลังจะมาเร็วๆนี้....</h1>
        }
        modalBodyClassName="p-6 space-y-6 dark:text-white"
        isVisible={addModal}
