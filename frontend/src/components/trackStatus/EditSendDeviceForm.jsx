...
export default React.memo(function EditSendDeviceForm({
  onSubmit,
  defaultData,
  ...
  useEffect(() => {
    if (defaultData) {
      ...
      for (const [key, value] of Object.entries(defaultData)) {
        switch (key) {
          // case 'Efficacies': setValue('efficacyIds', value.map(item => item.id)); break;
          // case 'Packages': setValue('packagingIds', value.map(item => item.id)); break;
          // case 'SkinTypes': setValue('skinTypeIds', value.map(item => item.id)); break;
